        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 id="set-scroll" class="section-title bg-white text-center text-primary px-3">Blog Add</h6>
                </div>
                <div class="container wow fadeInUp g-4" data-wow-delay="0.3s">   
                    <div class="contact-form">                       
                        ...
                        <div class="controls">
                            ...
                            <div class="form-group">
                                <p >Thumbnai URL</p>
                                <input type="text" name="thumbnai" v-model="thumbnailUrl" class="form-input-text form-control"  required="required">                           
                            </div>
                            <div class="form-group">
                                <p>Description</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="bottom-margin" >
                                    <div class="btn bt-send-msg" @click="addBlog()">Add</div>
                                </div>
                            </div>
                        </form>
                    </div>
...
export default ({
    ...
    methods: {
        async addBlog(){
            let res = await BlogServices.addBlog(this.blogTitle, this.blogDescription, this.blogContent, this.thumbnailUrl)
            if(res.data == true){
                    this.$notify({
                        group: 'foo',
                        type: 'success ',
                        text: 'Add blog successful'
                    });
