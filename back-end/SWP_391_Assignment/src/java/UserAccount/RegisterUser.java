...
public class RegisterUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RegisterUserRequest user_request = gson.fromJson(jb.toString(), RegisterUserRequest.class);  
            
            UserAccountContext uac = new UserAccountContext();
            String user_response = gson.toJson(uac.registerUser(user_request.getUsername(), 
            user_request.getPassword(),user_request.getDob(),user_request.getAddress()));
