...
public class SearchUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            SearchTextRequest user_request = gson.fromJson(jb.toString(), SearchTextRequest.class);  
            
            UserAccountContext uac = new UserAccountContext();
            String res = gson.toJson(uac.searchUser(user_request.getText()));
