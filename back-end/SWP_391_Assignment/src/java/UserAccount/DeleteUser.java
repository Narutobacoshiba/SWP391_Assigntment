...
public class DeleteUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            DeleteUserRequest user_request = gson.fromJson(jb.toString(), DeleteUserRequest.class);  
            
            UserAccountContext uac = new UserAccountContext();
            String user_response = gson.toJson(uac.deleteUser(user_request.getUsername(),user_request.getPassword()));
