...
public class UpdateUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            UpdateUserRequest user_request = gson.fromJson(jb.toString(), UpdateUserRequest.class);  
            
            UserAccountContext uac = new UserAccountContext();
            String user_response = gson.toJson(uac.updateUser(user_request.getUsername(), 
